...
{
    public class EmailServicePuembo : IEmailServicePuembo
    {
        private readonly EmailConfigurationPuembo _emailConfiguration;
        private readonly ITemplateService _templateService;
        private readonly IWebHostEnvironment _environment;
        public EmailServicePuembo(
            EmailConfigurationPuembo emailConfiguration,
